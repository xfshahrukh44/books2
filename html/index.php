            ...
            <div class="col-lg-6">
                <div class="now-noval">
                    ...
                    <div class="read-btn">
                        ...
                        <a href="featured-datails.php" class="btn btn-custom">Interview with the Author</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-12 p-0">
                <div class="sec4-main-img">
                    <figure>
                        <img src="images/BRAND-IMG.png" class="img-fluid" alt="">
                    </figure>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                <div class="sec3-text">
                    ...
                    <a href="bio.php" class="btn btn-custom sec3">More about the author</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3" data-aos="fade-down">
                <div class="sec6-opt">
                    <div class="sec6-opt-img">
                        <figure>
                            <img src="images/book10.jpg" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <!-- <div class="sec6-opt-text">
                        <h6>First Stone</h6>
          ...
          <div class="row align-items-center">
               ...
               <div class="col-lg-6" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <div class="sec7-img-book">
                         <figure>
                              <img src="images/old-person.webp" class="img-fluid" alt="">
                         </figure>
                    </div>
               </div>
          </div>
