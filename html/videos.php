        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="video">
                    ...
                    <a href="images/video-2.mp4" target="_blank"> 
            ...
            <div class="col-lg-4">
                <div class="video">
                    <h2>Conferencia sobre el liberalismo latinoamericano, Universidad Francisco Marroquín, Guatemala</h2>
                     <a href="images/video-1.mp4" target="_blank">
                    <video width="320" height="240" muted class="vid">
                    <source src="images/video-1.mp4" type="video/mp4" class="img-fluid">
                     </a>
                    </video>
            ...
            <div class="col-lg-4">
                <div class="video">
                    <h2>Entrevista con Felipe Pigna, Grupo Planeta, Argentina</h2>
                     <a href="images/video-3.mp4" target="_blank">
                    <video width="320" height="240" muted class="vid">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="video">
                    ...
                    <a href="images/video-4.mp4" target="_blank"> 
                    <video width="320" height="240" muted class="vid">
            ...
            <div class="col-lg-4">
                <div class="video">
                    <h2>Entrevista com Teixeira Coelho Netto no Itaú Cultural, Brasil</h2>
                     <a href="images/video-5.mp4" target="_blank">
                    <video width="320" height="240" muted class="vid">
                    <source src="images/video-5.mp4" type="video/mp4" class="img-fluid">
                     </a>
                    </video>
            ...
            <div class="col-lg-4">
                <div class="video">
                    <h2>Interview with Nicolas Shumway, Director of LLILAS</h2>
                     <a href="images/video-6.mp4" target="_blank">
                    <video width="320" height="240" muted class="vid">
                    <source src="images/video-6.mp4" type="video/mp4">
                     </a>
                    </video>
