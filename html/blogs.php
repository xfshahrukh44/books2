        ...
        <div class="row">
            ...
            <div class="col-lg-3" data-aos="fade-up">
                <div class="sec6-opt">
                    <div class="sec6-opt-img">
                        <figure>
                            <img src="images/sec5-opt1.png" class="img-fluid" alt="">
                        </figure>
                    </div>
            ...
            <div class="col-lg-3" data-aos="fade-down">
                <div class="sec6-opt">
                    <div class="sec6-opt-img">
                        <figure>
                            <img src="images/sec5-opt2.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="sec6-opt-text">
            ...
            <div class="col-lg-3" data-aos="fade-up">
                <div class="sec6-opt">
                    <div class="sec6-opt-img">
                        <figure>
                            <img src="images/sec5-opt3.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="sec6-opt-text">
                        <h6>Yesterday’s Shadows</h6>
            ...
            <div class="col-lg-3" data-aos="fade-down">
                <div class="sec6-opt">
                    <div class="sec6-opt-img">
                        <figure>
                            <img src="images/sec5-opt4.png" class="img-fluid" alt="">
                        </figure>
                    </div>
                    <div class="sec6-opt-text">
                        <h6>First Stone</h6>
